...
integration_data* allocate_integration_managed(long bufsize) {
    ...
    cudaMallocManaged(&(data->tau11_4d_chunk), bufsize*sizeof(float));
    cudaMallocManaged(&(data->tau22_4d_chunk), bufsize*sizeof(float));
    cudaMallocManaged(&(data->tau33_4d_chunk), bufsize*sizeof(float));
    cudaMallocManaged(&(data->tau12_4d_chunk), bufsize*sizeof(float));
    cudaMallocManaged(&(data->tau13_4d_chunk), bufsize*sizeof(float));
    cudaMallocManaged(&(data->tau23_4d_chunk), bufsize*sizeof(float));
...
void deallocate_integration_managed(integration_data *data) {
    ...
    cudaFree(data->tau11_4d_chunk);
    cudaFree(data->tau22_4d_chunk);
    cudaFree(data->tau33_4d_chunk);
    cudaFree(data->tau12_4d_chunk);
    cudaFree(data->tau13_4d_chunk);
    cudaFree(data->tau23_4d_chunk);
